...
public class RoadService extends IntentService {

    private final String LOG_TAG = RoadService.class.getSimpleName();
...
//            if (mIsDebugging) {
//                //XML 파일로 테스트하기
//                InputStream inputStream = this.getResources().openRawResource(R.raw.sample_data1);
//                try {
...
*/
                ...
                if (roadValues.size() > 0) {
                    this.getContentResolver().insert(HallasanContract.RoadEntry.CONTENT_URI, roadValues);
                }
            }
    ...
    static public class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Intent sendIntent = new Intent(context, RoadService.class);
            sendIntent.putExtra(RoadService.CALENDAR_EXTRA , calendar);
